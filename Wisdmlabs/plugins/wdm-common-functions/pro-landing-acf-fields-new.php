...
class ProLandingAcfFieldsNew
{
    ...
    // Save Our Team Details
        ...
        $this->wdmSaveQuotesJson();

    // Unset all meta property
        unset($this->all_meta);
    }

    public function wdmSaveQuotesJson(){
        $quotes = [];
        if (isset($this->all_meta['quote_section_title'][0])) {
            $quotes['title'] = $this->all_meta['quote_section_title'][0];
        }
        if (isset($this->all_meta['quote_section_description'][0])) {
            $quotes['description'] = $this->all_meta['quote_section_description'][0];
        }
        if (isset($this->all_meta['quote_author'][0])) {
            $quotes['author'] = $this->all_meta['quote_author'][0];
        }
        if (isset($this->all_meta['quote_author_subtitle'][0])) {
            $quotes['author_subtitle'] = $this->all_meta['quote_author_subtitle'][0];
        }
        if (isset($this->all_meta['quote_author_comment'][0])) {
            $quotes['quote'] = $this->all_meta['quote_author_comment'][0];
        }
        if (isset($this->all_meta['quote_author_image'][0])) {
            $quotes['author_image'] = wp_get_attachment_url($this->all_meta['quote_author_image'][0]);
        }
        if (isset($this->all_meta['quote_start_image'][0])) {
            $quotes['quote_start_image'] = wp_get_attachment_url($this->all_meta['quote_start_image'][0]);
        }
        if (isset($this->all_meta['quote_end_image'][0])) {
            $quotes['quote_end_image'] = wp_get_attachment_url($this->all_meta['quote_end_image'][0]);
        }
        if ($quotes) {
            file_put_contents($this->folder_path.'/quote.json', json_encode($quotes));
        }
        unset($quotes);
    }
    ...
    public function saveBannerMetaData($banner)
    {
        ...
        if (isset($this->all_meta['product_banner_p_b_btn_text'][0])) {
            $banner['banner_button_text'] = $this->all_meta['product_banner_p_b_btn_text'][0];
        }
        if (isset($this->all_meta['product_banner_p_b_btn_url'][0])) {
            $banner['banner_button_link'] = $this->all_meta['product_banner_p_b_btn_url'][0];
        }
        return $banner;
    }
    ...
    public function wdmSaveScreenshotsJson()
    {
        ...
        if (isset($this->all_meta['p_screenshots_section_description'][0])) {
            $screenshots['subtitle'] = $this->all_meta['p_screenshots_section_description'][0];
        }
        if (isset($this->all_meta['p_screenshots_section_full_image'][0])) {
            $screenshots['full_image'] = wp_get_attachment_url($this->all_meta['p_screenshots_section_full_image'][0]);
        }
        ...
        if (isset($this->all_meta['product_screenshots'][0]) && $this->all_meta['product_screenshots'][0] > 0) {
            for ($i=0; $i<$this->all_meta['product_screenshots'][0]; $i++) {
                ...
                if (isset($this->all_meta['product_screenshots_'.$i.'_p_screenshot_descrition'][0])) {
                    $screenshots['items'][$i]['description'] = $this->all_meta['product_screenshots_'.$i.'_p_screenshot_descrition'][0];
                }
                if (isset($this->all_meta['product_screenshots_'.$i.'_p_screenshot_image'][0])) {
                    $screenshots['items'][$i]['image'] = wp_get_attachment_url($this->all_meta['product_screenshots_'.$i.'_p_screenshot_image'][0]);
                }
                if (isset($this->all_meta['product_screenshots_'.$i.'_min_height'][0])) {
                    $screenshots['items'][$i]['min_height'] = wp_get_attachment_url($this->all_meta['product_screenshots_'.$i.'_min_height'][0]);
                }
                if (isset($this->all_meta['product_screenshots_'.$i.'_p_screenshot_right_aligned'][0])) {
                    $screenshots['items'][$i]['right_aligned'] = $this->all_meta['product_screenshots_'.$i.'_p_screenshot_right_aligned'][0];
                }
                if (isset($this->all_meta['product_screenshots_'.$i.'_p_screenshot_right_aligned_index'][0])) {
                    $screenshots['items'][$i]['right_aligned_index'] = $this->all_meta['product_screenshots_'.$i.'_p_screenshot_right_aligned_index'][0];
                }
    ...
    public function wdmSaveDemoJson()
    {
        ...
        $demo = $this->wdmGetDemosMeta($demo);
        if ($demo) {
    ...
    public function wdmGetDemosMeta($demos)
    {
        if (isset($this->all_meta['p_demo_section_title'][0])) {
            $demos['title'] = $this->all_meta['p_demo_section_title'][0];
        }
        if (isset($this->all_meta['p_demo_section_image'][0])) {
            $demos['demo_image'] = wp_get_attachment_url($this->all_meta['p_demo_section_image'][0]);
        }
        $demos['view_demo_button'] = [];
        $demos['buy_now_button'] = [];
        if (isset($this->all_meta['p_demo_section_view_button_button_text'][0])) {
            $demos['view_demo_button']['text'] = $this->all_meta['p_demo_section_view_button_button_text'][0];
        }
        if (isset($this->all_meta['p_demo_section_view_button_button_url'][0])) {
            $demos['view_demo_button']['url'] = $this->all_meta['p_demo_section_view_button_button_url'][0];
        }
        if (isset($this->all_meta['p_demo_section_view_button_button_class'][0])) {
            $demos['view_demo_button']['class'] = $this->all_meta['p_demo_section_view_button_button_class'][0];
        }
        if (isset($this->all_meta['p_demo_section_buy_button_button_text'][0])) {
            $demos['buy_now_button']['text'] = $this->all_meta['p_demo_section_buy_button_button_text'][0];
        }
        if (isset($this->all_meta['p_demo_section_buy_button_button_url'][0])) {
            $demos['buy_now_button']['url'] = $this->all_meta['p_demo_section_buy_button_button_url'][0];
        }
        if (isset($this->all_meta['p_demo_section_buy_button_button_class'][0])) {
            $demos['buy_now_button']['class'] = $this->all_meta['p_demo_section_buy_button_button_class'][0];
        }

        if(empty($demos['view_demo_button'])){
            unset($demos['view_demo_button']);
        }
        if(empty($demos['buy_now_button'])){
            unset($demos['buy_now_button']);
        }
        return $demos;
    }
