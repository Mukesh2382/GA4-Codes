...
class WdmSale
{
	...
	if ( empty(get_field('show_sale_strip','option'))  ) {
        ...
        if ( $should_show_strip_on_blogs_only && ! is_single() ) {
            return $content;
        } else if ( is_page( 'my-account' ) || is_page( 'login' ) ) {
            // If current page is my-account page.
            $content = '<div class="distitlediv" style=""> <img src="https://wisdmlabs.com/site/wp-content/uploads/2022/11/bfcm-my-account-banner-graphic.png" data-src="https://wisdmlabs.com/site/wp-content/uploads/2022/11/bfcm-my-account-banner-graphic.png" class="site-wide-banner-graphic-left" alt="site-wide-banner-graphic" style="width:12%" data-was-processed="true"><div style="display:flex;flex-direction:column;padding:18px 0" class="qwerty"><strong style="font-weight:700 !important;color:#FFEC5F; font-size:26px;line-height: 20px;">Grow your eLearning & eCommerce Business at a Bargain!</strong><div><strong style="font-weight:700 !important;color:#FFF"> Enjoy access to the PRO features at up to <strong style="color:#FFEC5F">70% off </strong> this Black Friday - </strong><strong style="color:#FFEC5F;font-size:26px""> Upgrade Now </strong></div></div><img src="https://wisdmlabs.com/site/wp-content/uploads/2022/11/bfcm-my-account-banner-graphic.png" data-src="https://wisdmlabs.com/site/wp-content/uploads/2022/11/bfcm-my-account-banner-graphic.png" class="site-wide-banner-graphic-right transform-left" alt="site-wide-banner-graphic" style="width:12%" data-was-processed="true"> </div> <style>' . esc_html($strip_css) . '</style>';
