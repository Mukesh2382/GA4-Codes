jQuery(document).ready(function() {
    ...
    function updateMinimalCheckoutTotalSubtotalDetails(response){
        ...
        jQuery('.sub-discount-row .edd_cart_discount').html(response.coupon_value);
        ...
        if(typeof response.coupon_value!=='undefined' ){
            ...
            if(response.coupon_value==''){
                ...
                // Start of BFCM Code
                if ( 'wisdmbfcm22' == response.code.toLowerCase() ) {
                    jQuery('#wdm_coupon_amount').html(' '+ response.code + ' ');
                } else {
                    jQuery('#wdm_coupon_amount').html(' '+ response.amount + ' ');
                }
                // End of BFCM Code
    ...
    function process_after_apply_discount(discount_response){
        if (discount_response.msg == 'valid') {
            ...
            jQuery('.sub-discount-row .edd_cart_discount').html(discount_response.coupon_value);
            ...
            // Start of BFCM Code
            if ( 'wisdmbfcm22' == discount_response.code.toLowerCase() ) {
                jQuery('#wdm_coupon_amount').html(' '+ discount_response.code + ' ');
            } else {
                jQuery('#wdm_coupon_amount').html(' '+ discount_response.amount + ' ');
            }
            // End of BFCM Code
