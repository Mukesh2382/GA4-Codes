...
jQuery(document).ready(function($) {
    ...
    // Added return false; by Tariq to allow only custom designed login form to work
            ...
            if ($.trim(data) == 'success') {
                $.post(edd_global_vars.ajaxurl, 'action=wdm_ga4_add_payment_info', function( ga4_data ){
                    try {
                        ...
                        var payment_element = document.querySelector('input[name="payment-mode"]:checked');
                        if(payment_element === null){
                            var pay_mode = 'Credit Card';
                        }
                        else{
                            var payment_mode = payment_element.value;
                        ...
                        window.dataLayer.push({
                            ...
                            ecommerce: {
                                ...
                                // items: [{
                                //     item_id: "SKU_12345",
                                //     item_name: " WISDM LearnDash Essential Add-Ons Pack ",
                                //     discount: 0.00,
                                //     index: 0,
