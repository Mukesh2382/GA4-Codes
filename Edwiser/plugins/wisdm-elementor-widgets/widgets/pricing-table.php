...
class MYEW_Pricing_Table_Widget extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Pricing Table', 'wisdm-elementor-widgets' );
    }
    ...
    public function register_controls() {
        ...
        $this->start_controls_section(
            'header_section',
            [
                'label' => __( 'Header', 'wisdm-elementor-widgets' ),
        ...
        $this->start_controls_section(
            'price_section',
            [
                'label' => __( 'Pricing', 'wisdm-elementor-widgets' ),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->start_controls_section(
            'listing_section',
            [
                'label' => __( 'Listing', 'wisdm-elementor-widgets' ),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
