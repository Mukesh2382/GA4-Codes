...
class MYEW_Logo_Carousel_Widget extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Logo Carousel', 'wisdm-elementor-widgets' );
    }
        ...
        $this->start_controls_section(
            ...
            $repeater->add_control(
                ...
                [
                    ...
                    'default' => __( 'SLider Title #1', 'wisdm-elementor-widgets' ),
                    'label_block' => true
                ]
            );
            $repeater->add_control(
            ...
            $this->add_control(
                'slider',
                [
                    'label' => __( 'Slider Items', 'wisdm-elementor-widgets' ),
                    'type' => \Elementor\Controls_Manager::REPEATER,
                    'fields' => $repeater->get_controls(),
                    'default' => [
                        [
                            'slider_title' => __( 'Slider title #1', 'wisdm-elementor-widgets' ),
                        ],
                    ],
