...
class Wisdm_Feature_Blocks_Widget extends Widget_Base {
    ...
    public function register_controls() {
        $this->start_controls_section(
            ...
            $this->add_control(
                'feature_view_screenshot_btn_label',
                [
                    'label' => __( 'Button Label', 'wisdm-elementor-widgets' ),
                    'type' => \Elementor\Controls_Manager::TEXT,
    ...
    protected function render() {
        ...
        $feature_view_screenshot_btn_label = empty($settings['feature_view_screenshot_btn_label']) ? 'View Screenshot' : $settings['feature_view_screenshot_btn_label'];
        ...
        <div class="wdm-feature-block">
            ...
            <a class="wdm-fb-view-screenshot open-modal"  href='javascript:void(0)' data-modal='feature-box-modal' data-screenshot="<?php echo $feature_screenshot; ?>"><?php echo esc_html( $feature_view_screenshot_btn_label ); ?></a> 
        </div>
        <?php
    }
