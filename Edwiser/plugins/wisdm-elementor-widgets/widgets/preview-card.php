...
class MYEW_Preview_Card_Widget extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Preview Card Widget', 'wisdm-elementor-widgets' );
    }
    ...
    public function register_controls() {
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'image_link',
                [
                    'label' => __( 'Image Link' . date('His'), 'plugin-domain' ),
        ...
        $this->start_controls_section(
            'badge_section',
            [
                'label' => __( 'Badge', 'wisdm-elementor-widgets' ),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->start_controls_section(
            'button_section',
            [
                'label' => __( 'Button', 'wisdm-elementor-widgets' ),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
    ...
    private function style_tab() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Divider', 'wisdm-elementor-widgets' ),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Top Badge', 'wisdm-elementor-widgets' ),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Buy Button', 'wisdm-elementor-widgets' ),
                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
