    ...
    grunt.initConfig( {
        ...
        makepot: {
            target: {
                options: {
                    ...
                    potFilename: 'wisdm-elementor-widgets',
                    type: 'wp-plugin',
                }
            }
        },
        ...
        compress: {
            main: {
                options: {
                    mode: 'zip',
                    archive: './build/wisdm-elementor-widgets-v-' + pkg.version + '.zip',
                },
                expand: true,
                cwd: 'build/',
                src: [ '**/*' ],
                dest: 'wisdm-elementor-widgets'
            }
        },
        ...
        addtextdomain: {
            options: {
                textdomain: 'wisdm-elementor-widgets',
                updateDomains: [ 'wisdm-elementor-widgets' ]
            },
            target: {
                files: {
                    src: [
